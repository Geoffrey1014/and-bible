...
open class DownloadActivity : DocumentSelectionBase(NO_OPTIONS_MENU, R.menu.download_documents_context_menu) {
            ...
            suspendCoroutine<Boolean> {
                AlertDialog.Builder(this@DownloadActivity)
                    ...
                    .setPositiveButton(R.string.yes) {
                            _, _ -> it.resume(true)
                        Log.i("Themis", "Event 2: Clicked \"Yes\" in \"Do you want to proceed to download documents?\" dialog")

                    }
                    .setNegativeButton(R.string.do_not_ask_again) {_, _ ->
                        sharedPreferences.edit().putBoolean("download_do_not_ask", true).apply()
                        it.resume(true)
                        Log.i("Themis", "Event 2: Clicked \"download_do_not_ask\" in \"Do you want to proceed to download documents?\" dialog")

                    }
                    .setNeutralButton(R.string.cancel) {
                            _, _ -> it.resume(false)
                        Log.i("Themis", "Warning 2: Clicked \"Cancel\" in \"Do you want to proceed to download documents?\" dialog")
    ...
    private fun doDownload(document: Book) {
        ...
        Log.i("Themis", "Event 3: Downloaded a book: "+document.abbreviation)
    }
